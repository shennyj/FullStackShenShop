...
export const login = (email,password) => async (dispatch) => {
    try{
        ...
        //make post request to backend and get back token
        const {data} = await axios.post('/api/users/login/',
        {'username':email,'password':password},
        config)
        dispatch({
            type:USER_LOGIN_SUCCESS,
            payload:data//basic user info and token
        })
...
export const getUserDetails = (id) => async (dispatch,getState) => {
    try{
        ...
        dispatch({type:USER_DETAILS_FAIL,payload:err.response
            &&err.response.data.detail ? err.response.data.detail
            :err.message})
    }
}
...
export const updateUserProfile = (user) => async (dispatch,getState) => {
    try{
        ...
        dispatch({type:USER_UPDATE_PROFILE_FAIL,payload:err.response
            &&err.response.data.detail ? err.response.data.detail
            :err.message})
    }
}
